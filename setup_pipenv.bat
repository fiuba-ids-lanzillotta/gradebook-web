...
REM Verificar e instalar pipx si es necesario
...
if not exist ".env" (
    if exist ".env.example" (
        ...
        echo [OK] Archivo .env creado desde .env.example - revisa y completa sus valores antes de usar el panel de admin
    )
)
